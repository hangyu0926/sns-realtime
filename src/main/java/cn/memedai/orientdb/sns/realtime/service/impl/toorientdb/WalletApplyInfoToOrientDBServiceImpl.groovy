 ...
 */
@Service
class WalletApplyInfoToOrientDBServiceImpl implements RealTimeService {

    private static final LOG = LoggerFactory.getLogger(WalletApplyInfoToOrientDBServiceImpl.class)
