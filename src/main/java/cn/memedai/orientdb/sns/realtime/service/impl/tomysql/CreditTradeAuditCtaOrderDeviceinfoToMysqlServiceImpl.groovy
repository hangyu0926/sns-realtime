 ...
 */
@Service
class CreditTradeAuditCtaOrderDeviceinfoToMysqlServiceImpl {
    private static final LOG = LoggerFactory.getLogger(CreditTradeAuditCtaOrderDeviceinfoToMysqlServiceImpl.class)
