 ...
 */
@Service
class WalletMoneyBoxOrderToMysqlServiceImpl implements RealTimeService {

    private static final LOG = LoggerFactory.getLogger(WalletMoneyBoxOrderToMysqlServiceImpl.class)
